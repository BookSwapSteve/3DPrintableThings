...
Intended to hold the Kindle Fire in landscape orientation and for the Kindle Fire to be slid in from the top.
...
* Lower can be printed as is.
* Top should be rotated 180° so it can be printed without support material.

Check using layer view that the wall thickness for the USB cable does not result in it not being printed.
